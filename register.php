...
<?php
//php script
include("function/controller_register.php");
        ...
        <div class="container">
            <div class="row" align="center">
                <div class="col-lg-12 col-md-6 col-md-offset-3 col-md-pull-3 get-it">
                	<img alt="Brand" src="assets/images/bdvlogo.png" style="height:100px">
	...
	<div class="container-fluid full-width-container" align="center">
		...
		<div class="section section-custom billinfo" align="left">
          ...
          <div class="group-fields clearfix row">
                ...
                <input type="text" name="tgl_lahir" id="datetimepicker-date" class="form-control" required>
								<div class="help-block with-errors"></div>
							</div>
						</div>
						</div>
					...
					<div class="section section-custom billinfo" align="left">
			<!--section-title -->
			<h2 align="center" style="color:#231F20">Social Media (Opsional)</h2><!--section-title end -->
			<!-- section content start-->
