...
>>>>>>> 7c7eb4ea972d3fd43475169d013750880f27285d
			</ul>
		</li><!-- End user info -->
			...
			<table class="table table-mc-red pmd-table">
				...
				<tbody>
					...
					// LIMIT query membatasi data yang ditampilkan
						...
						$query = mysql_query("SELECT a.nama, a.email, a.profesi, a.foto, c.tgl_akses FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address AND c.tgl_akses LIKE '$searchTanggal' LIMIT $start, $limit");

					//Qsum query mencari jumlah data
						$Qsum = mysql_query("SELECT a.nama, a.email, a.profesi, a.foto, c.tgl_akses FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address AND c.tgl_akses LIKE '$searchTanggal'");
					...
					// show all data query
					// LIMIT query membatasi data yang ditampilkan
						$query = mysql_query("SELECT a.nama, a.email, a.profesi, a.foto, c.tgl_akses FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address LIMIT $start, $limit");

					//Qsum query mencari jumlah data
						$Qsum = mysql_query("SELECT a.nama, a.email, a.profesi, a.foto, c.tgl_akses FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address");
					}
					...
					?>
					<tr>
						<td data-title="Month"><img alt="80x80" data-src="holder.js/80x80" class="img-responsive" src="data:image/jpeg;base64, <?php echo base64_encode( $foto )?>" alt="Belum Ada Foto" data-holder-rendered="true" style="width: 80px;height: 40px"></td>
	      ...
	      if(isset($_GET['searchdata']))
		      {
		        ...
		        $rows=mysql_num_rows(mysql_query("SELECT a.nama, a.email, a.profesi, a.foto, c.tgl_akses FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address AND c.tgl_akses = LIKE '%$searchdata%'"));
		      }else
		      {
		        $rows=mysql_num_rows(mysql_query("SELECT a.nama, a.email, a.profesi, a.foto, c.tgl_akses FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address"));
		      }
