				...
				<div class="pmd-card-body statistics text-center">
					<ul class="list-group list-inline">
						...
						<li>
							...
							<?php
	            $Qvisit = mysql_query("SELECT * FROM tb_logs");
					...
					<ul class="list-group pmd-card-list pmd-list-avatar">
						...
						<?php
					      ...
					      //paging initiate variable
							...
							$today = date("Y-m-d");
							$Qabsensi = mysql_query("SELECT a.nama, a.email, a.profesi, a.foto FROM tb_user a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address AND c.tgl_akses = '$today' LIMIT $start, $limit");
...
FROM tb_user");
		...
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="pmd-card pmd-z-depth">
			 ...
			 <?php
			 $Qkeahlian = mysql_query("SELECT keahlian FROM tb_user");
			 ...
			 <div class="pmd-card-body text-center value-added">
				 <div class="row">
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">Web Developer</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_webdev;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">Graphic Design</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_graphdes;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">Digital Marketing</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_digmar;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">Game Developer</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_gamedev;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">Mobile Developer</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_mobdev;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">IT Programmer</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_itpro;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
						 <div class="source-semibold typo-fill-secondary title">IT Business</div>
						 <div class="pmd-display2"><a href="javascript:void(0)"><?php echo $persen_itbiz;?>%</a></div>
					 </div>
					 <div class="col-xs-6 value-added-section">
