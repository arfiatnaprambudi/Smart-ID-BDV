    ...
    <div class="container-fluid full-width-container value-added-detail-page">
		<div>
			...
			<form method="GET">
				...
				<a href="javascript:void(0);" class="btn btn-primary pmd-btn-raised add-btn pmd-ripple-effect pull-left">Daftar User</a>
			</form>
			</div>
			<!-- Title -->
			...
			<ol class="breadcrumb text-left">
			  ...
			  <li class="active">Data Membership</li>
			</ol><!--breadcrum end-->
		</div>
		<!-- Table -->
			...
			<table class="table table-mc-red pmd-table">
				...
				<tbody>
					...
					// LIMIT query membatasi data yang ditampilkan
						...
						$query = mysql_query("SELECT * FROM tb_user WHERE $searchby LIKE '%$searchdata%' LIMIT $start, $limit");

					//Qsum query mencari jumlah data
						$Qsum = mysql_query("SELECT * FROM tb_user WHERE $searchby LIKE '%$searchdata%'");
					}
					...
					// show all data query
					// LIMIT query membatasi data yang ditampilkan
						$query = mysql_query("SELECT * FROM tb_user LIMIT $start, $limit");

					//Qsum query mencari jumlah data
						$Qsum = mysql_query("SELECT * FROM tb_user");
					}
					...
					<tr>
						...
						<td data-title="Month"><?php echo $perusahaan;?></td>
						<td data-title="Total"><?php echo $email;?></td>
	      ...
	      if(isset($_GET['searchdata']))
		      {
		        ...
		        $rows=mysql_num_rows(mysql_query("SELECT * FROM tb_user WHERE $searchby LIKE '%$searchdata%'"));
		      }else
		      {
		        $rows=mysql_num_rows(mysql_query("SELECT * FROM tb_user"));
		      }
